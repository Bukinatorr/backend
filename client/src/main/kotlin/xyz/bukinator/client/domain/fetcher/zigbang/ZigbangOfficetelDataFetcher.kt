...
class ZigbangOfficetelDataFetcher : ExternalDataFetcher {
    ...
    override fun fetchItemSummaries(itemIds: List<Long>): ExternalDataSummary {
        ...
        return ExternalDataSummary(ExternalDataSource.ZIGBANG, ExternalDataType.OFFICETEL, itemSummaies)
    }
    ...
    override fun fetchItemDetail(itemId : Long): ExternalDataDetail {
        ...
        return ExternalDataDetail(ExternalDataSource.ZIGBANG, ExternalDataType.OFFICETEL, itemDetail)
    }
}